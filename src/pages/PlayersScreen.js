...
const PlayersScreen = ({playersBase}) => {
  ...
  const teams = ["Spirit", "Pride", "Gotham FC", "Reign", "Thorns", "Dash","NC Courage", "Chicago Stars", "Utah Royals", "KC Current", "Louisville", "Angel City", "SD Wave", "Bay FC"] ; // More teams can be added
